...
public abstract class Patch {
    ...
    protected final void addHotfixExecutable(Method method, int id) {
     ...
     * 新增的方法不在此集合中保存
     */
    private final HashMap<Object, Integer> mFixedExecutableIds = new HashMap<>();
    ...
    final Object apply(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        return methodId == null ? joinPoint.proceed() : invokeWithId(methodId, target, prams);
    }
